<x-app-layout>
    ...
    <x-slot name="slot">
        <x-create-card>
            ...
            @endif
            <p class="font-bold mb-3 text-xl">Activar serveis de autentificació externs</p>
            <form method="POST" action="{{ route('admin.settings.update') }}">
                @csrf
            <div class="columns mt-4">
                <!-- Oauth settings list -->
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 bg-gray">

                        <div class="toggle colour">
                                <div class="w-full mb-3 text-center bg-transparent text-red-900 font-semibold  border border-red-600">
                                    <div class="flex">

                                        <div class="flex-1 w-32 mt-3">
                                           <div class="mr-12">
                                               <svg class="icon 0" xmlns="http://www.w3.org/2000/svg" viewBox="1 2 20 20">
                                                   <path d="M20.283 10.356h-8.327v3.451h4.792c-.446 2.193-2.313 3.453-4.792 3.453a5.27 5.27 0 0 1-5.279-5.28 5.27 5.27 0 0 1 5.279-5.279c1.259 0 2.397.447 3.29 1.178l2.6-2.599c-1.584-1.381-3.615-2.233-5.89-2.233a8.908 8.908 0 0 0-8.934 8.934 8.907 8.907 0 0 0 8.934 8.934c4.467 0 8.529-3.249 8.529-8.934 0-.528-.081-1.097-.202-1.625z"></path>
                                               </svg>
                                               <span class="px-3  justify-center">  Google</span></div>
                                        </div>

                                        <div class="flex-2 w-32">
                                            <div class="ml-4">
                                                <input type="hidden" name="oauth[oauth_google]" value="0" />
                                                <input id="check1" class="toggle-checkbox hidden" type="checkbox" name="oauth[oauth_google]" @if($oauthFields['oauth_google']) checked @else notchecked @endif />
                                                <label for="check1" class="toggle-label block w-12 h-6 rounded-full transition-color duration-150 ease-out my-3"></label>
                                            </div>
                                        </div>
                                    </div>
                            </div>
                    ...
                    <div class="toggle colour">
                        <div class="w-full  mb-3 text-center bg-transparent text-blue-900 font-semibold  border border-blue-600">
                            <div class="flex">

                                <div class="flex-1 w-32 mt-3">
                                    <div class="mr-12">
                                        <svg class="icon ml-1 0" viewBox="0 -28.5 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
                                            <g>
                                        ...
                                        <span class="px-3 justify-center">  Discord</span></div>
                                </div>

                                <div class="flex-2 w-32">
                                    <div class="ml-4">
                                        <input type="hidden" name="oauth[oauth_discord]" value="0" />
                                        <input id="check2" class="toggle-checkbox hidden" type="checkbox" name="oauth[oauth_discord] "@if($oauthFields['oauth_discord']) checked @else notchecked @endif>
                                        <label for="check2" class="toggle-label block w-12 h-6 rounded-full transition-color duration-150 ease-out my-3"></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- ... -->
                    <div class="toggle colour">
                        <div class="w-full mb-3 text-center bg-transparent text-gray-900 font-semibold  border border-gray-600">
                            <div class="flex">
                                ...
                                <div class="flex-1 w-32 mt-3">
                                    <div class="mr-12">
                                        ...
                                        <span class="px-3  justify-center">  Github</span></div>
                                </div>

                                <div class="flex-2 w-32">
                                    <div class="ml-4">
                                        <input type="hidden" name="oauth[oauth_github]" value="0" />
                                        <input id="check3" class="toggle-checkbox hidden" type="checkbox" name="oauth[oauth_github]" @if($oauthFields['oauth_github']) checked @else notchecked @endif>
                                        <label for="check3" class="toggle-label block w-12 h-6 rounded-full transition-color duration-150 ease-out my-3"></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="toggle colour">
                        <div class="w-full mb-3 text-center bg-transparent text-purple-900 font-semibold  border border-purple-700">
                            <div class="flex">
                                ...
                                <div class="flex-1 w-32 mt-3">
                                    <div class="mr-6">
                                        ...
                                        <span class="px-3  justify-center">  Instagram</span></div>
                                </div>

                                <div class="flex-2 w-32">
                                    <div class="ml-4">
                                        <input type="hidden" name="oauth[oauth_instagram]" value="0" />
                                        <input id="check4" class="toggle-checkbox hidden" type="checkbox" name="oauth[oauth_instagram]" @if($oauthFields['oauth_instagram']) checked @else notchecked @endif>
                                        <label for="check4" class="toggle-label block w-12 h-6 rounded-full transition-color duration-150 ease-out my-3"></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="toggle colour">
                        <div class="w-full mb-3 text-center bg-transparent text-blue-900 font-semibold  border border-blue-600">
                            <div class="flex">
                                ...
                                <div class="flex-1 w-32 mt-3">
                                    <div class="mr-12">
                                        <svg viewBox="1 2 20 26" xmlns="http://www.w3.org/2000/svg" class="icon ml-2 mr-1 0">
                            ...
                            c1.188,0,2.116,0.396,3.254,0.715L20.125,9.167z"></path>
                                        </svg>
                                        <span class="px-3  justify-center">  Facebook</span></div>
                                </div>

                                <div class="flex-2 w-32">
                                    <div class="ml-4">
                                        <input type="hidden" name="oauth[oauth_facebook]" value="0" />
                                        <input id="check5" class="toggle-checkbox hidden" type="checkbox" name="oauth[oauth_facebook]" @if($oauthFields['oauth_facebook']) checked @else notchecked @endif>
                                        <label for="check5" class="toggle-label block w-12 h-6 rounded-full transition-color duration-150 ease-out my-3"></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="toggle colour">
                        <div class="w-full mb-3 text-center bg-transparent text-blue-900 font-semibold  border border-blue-600">
                            <div class="flex">
                                ...
                                <div class="flex-1 w-32 mt-3">
                                    <div class="mr-12">
                                        <svg class="icon ml-1 0" xmlns="http://www.w3.org/2000/svg" viewBox="1 2 20 20">
                                        ...
                                        <span class="px-3  justify-center">  VKontakt</span></div>
                                </div>

                                <div class="flex-2 w-32">
                                    <div class="ml-4">
                                        <input type="hidden" name="oauth[oauth_vk]" value="0" />
                                        <input id="check6" class="toggle-checkbox hidden" type="checkbox" name="oauth[oauth_vk]" @if($oauthFields['oauth_vk']) checked @else notchecked @endif>
                                        <label for="check6" class="toggle-label block w-12 h-6 rounded-full transition-color duration-150 ease-out my-3"></label>
                                    </div>
                                </div>
                            </div>
                        </div>
