            ...
            <header class="card-header">
                ...
                <button class="button-table-add">
                    <div class="button-table-add-separation">
                        ...
                        <a href="/admin/departments/create">Afegir Department</a>                    
                    </div>
                </button>
            </header>
                        ...
                        <tr>
                            ...
                            <td class="actions-cell">
                                <div class="buttons right nowrap">
                                    ...
                                    <button class="button-table-delete" data-target="sample-modal" type="button" onclick="return confirm('Estas Segur?')">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
