        ...
        <section class="section main-section">
            ...
            <div class="card has-table">
                <header class="card-header">
                    ...
                    <button class="button-table-add">
                        <div class="button-table-add-separation">
                            ...
                            <a href="{{ route("admin.types.create") }}">Afegir Tipus</a>
                        </div>
                    </button>
                </header>
                <div class="card-content">
                            ...
                            <tr>
                                ...
                                <td class="actions-cell">
                                    <div class="buttons right nowrap">
                                        ...
                                        <a href="{{ url('/admin/types/edit/' . $type['id']) }}">
                    ...
                    <x-pagination>
                        @for($i = 0; $i < $types->lastPage(); $i++)
                            <div class="buttons">
                                <a class="pagination-next m-2" href="{{ url('/admin/types?page=' . $i+1) }}" >
                                    @if($types->currentPage() == $i+1) 
                        ...
                        @endfor
                        <small class="flex w-full justify-end mr-0.5">Pàgina {{ $types->currentPage() }} de {{ $types->lastPage() }} </small>
                    </x-pagination>
                </div>
            </div>
        </section>
