                ...
                <div class="card-content">
                            ...
                            <tr>
                                ...
                                <td class="actions-cell">
                                    <div class="buttons right nowrap">
                                        <a href="{{ url('/admin/zones/view/' . $item['id']) }}" class="button-table-view"  data-target="sample-modal-2" type="button">
                    ...
                    <x-pagination>
                        @for($i = 0; $i < $history->lastPage(); $i++)
                            <div class="buttons">
                                <a class="pagination-next m-2" href="{{ url('/admin/zones/history/'.$id.'?history=' . $i+1) }}" >
