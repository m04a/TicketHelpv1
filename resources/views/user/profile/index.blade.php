...
<x-create-card>
        <form method="POST" action="{{ url('/user/profile/reset') }}">
            @csrf
            <div class="content-column">
                <!-- Email User -->
                <div class="column-right">
            ...
            <div class="grid grid-cols-2 m-8 gap-8">
                @if($oauthData['oauth_github'] == 1)
                    <a href="{{ url('/auth/github/redirect') }}">
                        <div class="hover:fill-gray-50 mb-2 text-center bg-transparent hover:bg-gray-700 text-gray-900 font-semibold hover:text-white py-3  border border-gray-600 hover:border-transparent transition ease-in-out duration-150">
                ...
                @if($oauthData['oauth_google'] == 1)
                    <a href="{{ url('/auth/google/redirect') }}">
                        <div class="hover:fill-red-100 mb-2 text-center bg-transparent hover:bg-red-700 text-red-900 font-semibold hover:text-white py-3  border border-red-600 hover:border-transparent transition ease-in-out duration-150">
                ...
                @if($oauthData['oauth_discord'] == 1)
                    <a href="{{ url('/auth/discord/redirect') }}">
                        <div
                            class="w-full hover:fill-red-100 mb-2 text-center bg-transparent hover:bg-blue-700 text-blue-800 font-semibold hover:text-white py-3  border border-blue-700 hover:border-transparent transition ease-in-out duration-150">
                ...
                @if($oauthData['oauth_instagram'] == 1)
                    <a href="{{ url('/auth/instagram/redirect') }}">
                        <div class="w-full hover:fill-red-100 mb-2 text-center instagram text-purple-800 font-semibold hover:text-white py-3  border border-purple-700 hover:border-transparent transition ease-in-out duration-150">
                ...
                @if($oauthData['oauth_facebook'] == 1)
                    <a href="{{ url('/auth/facebook/redirect') }}">
                        <div class="w-full hover:fill-blue-100 mb-2 text-center bg-transparent hover:bg-blue-500 text-blue-500 font-semibold hover:text-white py-3  border border-blue-500 hover:border-transparent transition ease-in-out duration-150">
                            <svg class="icon mr-1 0" xmlns="http://www.w3.org/2000/svg" viewBox="1 2 20 20">
                ...
                @if($oauthData['oauth_reddit'] == 1)
                    <a href="{{ url('/auth/reddit/redirect')}}">
                        <div class="w-full hover:fill-orange-100 mb-2 text-center bg-transparent hover:bg-orange-500 text-orange-500 font-semibold hover:text-white py-3  border border-orange-500 hover:border-transparent transition ease-in-out duration-150">
                            <svg class="icon mr-1 0" xmlns="http://www.w3.org/2000/svg" viewBox="1 2 20 20">
                ...
                @if($oauthData['oauth_gitlab'] == 1)
                    <a href="{{ url('/auth/gitlab/redirect')}}">
                        <div class="w-full hover:fill-red-100 mb-2 text-center bg-transparent hover:bg-orange-600 text-orange-500 font-semibold hover:text-white py-3  border border-orange-300 hover:border-transparent transition ease-in-out duration-150">
                            <svg class="icon mr-1 0" xmlns="http://www.w3.org/2000/svg" viewBox="1 2 20 20">
