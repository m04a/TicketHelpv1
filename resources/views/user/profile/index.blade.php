...
<x-create-card>
        ...
        <div class="content-column">
            ...
            <div class="column-left">
                ...
                <x-input id="nom" class="input-content input-disabled" type="text" name="username" value="{{ $users[0]['username'] }}" required  autofocus disabled />
            </div>
            ...
            <div class="column-right">
                ...
                <x-input id="email" class="input-content input-disabled" type="text" name="email" value="{{ $users[0]['email'] }}" required  autofocus disabled />
            </div>
        </div>
