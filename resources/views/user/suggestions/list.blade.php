            ...
            <div class="card has-table">
                ...
                <div class="card-content">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td data-label="Títol">Rajoy ipsum</td>
                                <td data-label="Estat">Pendent</td>
                                <td data-label="Departament">Administració</td>
                            ...
                            <tr>
                                <td data-label="Títol">Obama ipsum</td>
                                <td data-label="Estat">Pendent</td>
                                <td data-label="Departament">Relacions internacionals</td>
                                <td class="actions-cell">
                                    <div class="buttons right nowrap">
                            ...
                            <tr>
                                <td data-label="Títol">Trump ipsum</td>
                                <td data-label="Estat">Pendent</td>
                                <td data-label="Departament">Noticies</td>
                                <td class="actions-cell">
                                    <div class="buttons right nowrap">
